...
1. [Serial.find()](serial/Serial.find().md)
1. [Serial.findUntil()](serial/Serial.findUntil().md)
1. [Serial.flush()](serial/Serial.flush().md)
1. [Serial.getTimeout()](serial/Serial.getTimeout().md)
1. [if(Serial)](serial/if(Serial).md)
1.[Serial.parseFloat()]()
1. [Serial.print()](serial/Serial.print().md)
2. [Serial.println()](serial/Serial.println().md)
1. [Serial.setTimeout()](serial/Serial.setTimeout().md)
